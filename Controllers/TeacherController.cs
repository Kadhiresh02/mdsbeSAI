...
//        public async Task<ActionResult<TeacherDTO>> PostTeacher([FromBody] TeacherDTO teacherDto)
//        {
//            if (teacherDto == null || teacherDto.User == null)
//            {
//                return BadRequest("Invalid teacher data or missing user details.");
//            }

//            var existingUser = await _context.Users.FindAsync(teacherDto.User.UserId);
//            User userEntity;
...
//                Courses = teacherDto.Courses?.Select(c => new Course
//                {
//                    CourseName = c.CourseName,
//                    Description = c.Description
//                }).ToList() ?? new List<Course>()
...
//            // Unlink courses from the teacher before deleting
//            foreach (var course in teacher.Courses)
//            {

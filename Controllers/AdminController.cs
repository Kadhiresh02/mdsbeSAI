    ...
    public class AdminController : ControllerBase
    {
        ...
        public async Task<ActionResult<BatchDTO>> CreateBatch([FromBody] BatchDTO batchDto)
        {
            try
            {
                ...
                // Add batch to context and save changes
                _context.Batches.Add(batch);
                await _context.SaveChangesAsync();

                // Logging for debugging
                Console.WriteLine($"Batch created with ID: {batch.BatchId}");
                ...
                // Return CreatedAtAction to return the full batch with 201 Created status
        ...
        {
            var batch = await _context.Batches.FirstOrDefaultAsync(b => b.BatchId == id);
